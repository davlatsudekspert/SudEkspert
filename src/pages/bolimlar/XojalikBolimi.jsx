...
export default function XojalikBolimi() {
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-10 py-16">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-extrabold text-blue-900">Xo'jalik bo'limi</h1>
      </div>

      <div className="bg-white border border-blue-100 rounded-xl shadow-sm p-6 md:p-8">
        <p className="text-gray-600 leading-relaxed">Bino va inshootlarni texnik jihatdan saqlash, moddiy-texnika ta'minoti, kommunal xizmatlar va xo'jalik ishlarini tashkil etadi.</p>
      </div>
    </div>
  );
}
