...
export default function Provizor() {
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-10 py-16">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-extrabold text-blue-900">Provizor</h1>
      </div>

      <div className="bg-white border border-blue-100 rounded-xl shadow-sm p-6 md:p-8">
        <p className="text-gray-600 leading-relaxed">Laboratoriya faoliyati uchun zarur reaktivlar, dori vositalari va tibbiy buyumlarni qabul qilish, hisobini yuritish va saqlashni ta'minlaydi.</p>
      </div>
    </div>
  );
}
