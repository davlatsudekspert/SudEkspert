...
export default function AktBolimi() {
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-10 py-16">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-extrabold text-blue-900">AKT (Axborot-kommunikatsiya texnologiyalari)</h1>
      </div>

      <div className="bg-white border border-blue-100 rounded-xl shadow-sm p-6 md:p-8">
        <p className="text-gray-600 leading-relaxed">Axborot tizimlari, kompyuter texnikasi va lokal tarmoqlarning uzluksiz ishlashini ta'minlaydi hamda axborot xavfsizligini nazorat qiladi.</p>
      </div>
    </div>
  );
}
